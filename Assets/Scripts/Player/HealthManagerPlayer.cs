...
public class HealthManagerPlayer : MonoBehaviour, IDamageable
{
    ...
    {
        maxHealthPoints = expManager.currentLevel * 5 + statManager.vitality * 10;
        healthBar.maxValue = maxHealthPoints;
        healthRegeneration = (int)Mathf.Floor(statManager.vitality / 10);
    }
}
